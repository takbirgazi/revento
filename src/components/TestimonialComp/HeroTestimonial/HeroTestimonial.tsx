            ...
            <div data-aos="fade-up" className="container mx-auto pt-20">
                ...
                <h2 className="w-fit mx-auto relative text-center text-white text-[40px] lg:text-[100px] uppercase font-medium tracking-tight font-anton">What Our Clients Say
                    ...
                    <div className="absolute top-[15%] -left-[2%]">
                        <figure className={`w-5 h-5 md:w-8 md:h-8 ${styles.slideAnim2}`}>
                            <Image className="h-full w-full" src="https://framerusercontent.com/images/y4wVMkeiXjVX3vDcMOkfXQl9agM.png" height={80} width={150} alt="Bounse" />
                        </figure>
                    </div>
                    <div className="absolute bottom-2 left-[48%]">
                        <figure className={`w-2 h-2 md:h-5 md:w-5 lg:h-10 lg:w-10 ${styles.slideAnim2}`}>
                            <Image className="h-full w-full" src="https://framerusercontent.com/images/hJ6RoGAdRo8JIs48JamG934Yg.png" height={80} width={80} alt="Slide" />
                        </figure>
                    </div>
                ...
                <p className='text-center max-w-xl mx-auto text-white'>Experience growth through innovative digital marketing designed to deliver results.</p>
            </div>
