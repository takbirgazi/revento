        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 items-center">
            <div className="w-full md:w-7/12">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p>And your wins? We celebrate them like they&apos;re ours. We didn’t start Motion Mark for the trends or the likes.</p>
                    <p>We started it because too many brilliant ideas were fading into the noise—not from lack of vision, but from lack of execution. The digital world is fast, crowded, and unforgiving. Brands either move forward or get left behind. That’s why we do things differently. We don’t just</p>
                    <p>build campaigns—<span className="font-semibold">we build momentum.</span> <br />We don’t chase vanity metrics—<span className="font-semibold">we drive real growth.</span></p>
